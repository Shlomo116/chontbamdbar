...
const ADMIN_PASSWORD = 'tzolent2024'; // Change this to your desired password
let menuData = {};
...
function changePassword() {
    ...
    if (confirm('האם אתה בטוח שברצונך לשנות את הסיסמה?')) {
        // In a real application, this would be saved securely on the server
        // For demo purposes, we'll update the global variable
